...
exports.newSession = function(test) {
    const qwiery = new Qwiery();
    test.throws(function() {
        qwiery._createNewSession(undefined, {});
    }, Error);
    test.throws(function() {
        qwiery._createNewSession(undefined, {userId: 4});
    }, Error);
    test.throws(function() {
        qwiery._createNewSession("hello");
    }, Error);
...
exports.keywords = function(test) {
    const q = new Qwiery();
    q.ask("quantum physics is so cool.").then(function(session) {
        test.equal(session.Keywords.length, 3);
        test.done();
    });
};

exports.dateParsing = function(test) {
    const qwiery = new Qwiery();
