...
class QTL extends ServiceBase {
     ...
     * @returns {*}
     */
    mutateOracleItem(oracleItem, session) {
        const that = this;
        ...
        function runner() {
            if(QTL._answerIsIntent(oracleItem.Template)) {
                ...
                oracleItem.Template = waitFor(that.mutate(oracleItem.Template, session, oracleItem.Wildcards, null));
                return oracleItem;
            }
        }
    ...
    mutationContext(session, variables, wildcards) {
        ...
        return {
            ...
            get language() {
                return Qwiery.Language || "english";
            },
            get services() {
