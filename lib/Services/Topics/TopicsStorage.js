...
class TopicsStorage extends StorageDomainBase {
    ...
    addTopic(topicName, userId) {
        ...
        function runner() {
            let user = waitFor(that.Topics.findOne({userId: userId}));
            if(utils.isUndefined(user)) {

                waitFor(that.Topics.insert({
                    userId: userId,
                ...
                waitFor(that.Topics.update(user, {userId: userId}));
            }
        }
    ...
    clearUserTopics(userId) {
        ...
        function runner() {
            ...
            if(utils.isDefined(user)) {
                user.topics = [];
                that.Topics.update(user, {userId: userId});
            }
        }
    ...
    getUserTopics(userId) {
        ...
        function runner() {
            let ut = waitFor(that.Topics.findOne({userId: userId}));
            if(utils.isUndefined(ut)) {
                return {};
            }
            else {
